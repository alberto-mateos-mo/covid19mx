...
golem::fill_desc(
  pkg_name = "covid19mx", # The Name of the package containing the App 
  pkg_title = "cov19MX", # The Title of the package containing the App 
  pkg_description = "A dashboard to visualise covid-19 data for Mexico.", # The Description of the package containing the App 
  ...
  repo_url = "https://github.com/alberto-mateos-mo/covid19mx" # The (optional) URL of the GitHub Repo
)     
...
usethis::use_ccby_license(name = "David Mateos")
...
usethis::use_data_raw( name = "covid19mx_data", open = FALSE )
